...
class Account {
  ...
  // Public Methid
  depost(val) {
    if (this.#loanApproval(val)) {
      // Called private method inside the class
...
const jay = new Account("Jay Mathews", "EUR", 1122);
jay.depost(100);
jay.depost(120);
console.log(jay.getDeposit());

///////////////////////////////////////
// Chaining Methods
jay.depost(100).depost(200); // But for this , the method should return this
